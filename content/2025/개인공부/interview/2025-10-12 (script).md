...
Looking at the formula, Pi=∑jezjezi, it might seem complex, but it's quite simple.
...
- The bottom part, the **denominator (**∑jezj**)**, is just the sum of all these positive numbers from every class.
...
- 아래에 있는 **분모(∑jezj)**는 이렇게 만들어진 모든 클래스의 양수 값들을 전부 더한 총합입니다.
